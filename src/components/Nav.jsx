				...
				<div className='navbar navbar-expand navbar-light bg-faded d-flex flex-wrap justify-content-between px-4 col-12 shadow-sm'>
					...
					<ul class="d-flex justify-content-center m-0 p-0 col-12">
							<div class="navbar-item ">
								<a className='navbar-item' href="https://bookshop.org/lists/special-offers-on-bookshop-org">Special Offers</a>
							</div>
							<div class="navbar-item ">
								<a className='navbar-item' href="https://bookshop.org/lists/new-releases-this-week">New Books</a>
							</div>
							<div class="navbar-item ">
								<a className='navbar-item' href="/categories/m/popular-books">Best Sellers</a>
							</div>
							<div class="navbar-item ">
								<a className='navbar-item' href="/categories/m/teen-young-adult">Fiction</a>
							</div>
							<div class="navbar-item ">
								<a className='navbar-item' href="/categories/m/teen-young-adult">Novel</a>
							</div>
							<div class="navbar-item ">
								<a className='navbar-item' href="/categories/m/children-s-books">Fantasy</a>
							</div>
							<div class="navbar-item ">
								<a className='navbar-item' href="/categories/m/gifts-games-puzzles">Board Games</a>
							</div>
							<div class="navbar-item ">
								<a className='navbar-item' href="/categories/m/teen-young-adult">Other</a>
							</div>
						</ul>
				</div>
			</Row>
