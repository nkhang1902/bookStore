    ...
    <div>
        ...
        <div>
          <div class='content'>
            ...
            <Carousel className="d-flex overflow-auto" focusOnSelect={true} centerMode={true} responsive={responsive} showDots={false} >
              {Books.slice(0, 15).map(book=>( <Card key={book.id} className='bookcard m-2 p-1 border-0 shadow position-relative'>
              <a  href={`/BookDetails/${book.id}`}><img class='product--image rounded' src={book.data.ImageURL}/></a>
                </Card>
              ))}
            </Carousel>
            </div>
        ...
        <div>
          <div class='content'>
            ...
            <div class='crs'>
            <Carousel className="d-flex overflow-auto" focusOnSelect={true} centerMode={true} responsive={responsive} showDots={false} >
              {NewBooks.slice(0, 15).map(book=>( <Card key={book.id} className='bookcard m-2 p-1 border-0 shadow position-relative'>
              <a  href={`/BookDetails/${book.id}`}><img class='product--image rounded' src={book.data.ImageURL}/></a>
                </Card>
              ))}
            </Carousel>
        ...
        <div>
          <div class='content'>
            ...
            <div class='crs'>
            <Carousel className="d-flex overflow-auto" focusOnSelect={true} centerMode={true} responsive={responsive} showDots={false} >
              {DiscountBooks.slice(0, 15).map(book=>( <Card key={book.id} className='bookcard m-2 p-1 border-0 shadow position-relative'>
              <a  href={`/BookDetails/${book.id}`}><img class='product--image rounded' src={book.data.ImageURL}/></a>
                </Card>
              ))}
            </Carousel>
