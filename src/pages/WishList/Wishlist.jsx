...
const Wishlist = () => {
    ...
    const removeFromList = async (bookId) => {
        if (
            userData &&
            userData.Favourite &&
            userData.Favourite.includes(bookId)
        ) {
            const updatedFavourite = userData.Favourite.filter(
                (id) => id !== bookId
        ...
        return (
            <section className="cart-container d-flex flex-column text-center">
                ...
                <div className="design-system  mb-3">
                    <a
                        href="/login"
                        className="cart-redeem m-2 text-center"
                    >
                        Log In
                    </a>
                    or
                    ...
                    {books.map((book) => (
                        ...
                        >
                            ...
                            <div className="col-2 my-3">
                                ...
                                <div class="text-center m-0 text-decoration-line-through">
                                    ${book.Price}
                                </div>
                            </div>
